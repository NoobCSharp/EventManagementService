...
При запуске приложения схема базы данных создаётся автоматически с помощью:

`context.Database.EnsureCreated()`

Это означает:

   - Не требуется вручную создавать таблицы
   - База данных будет инициализирована при первом запуске
   - Миграции не используются (в текущей реализации)
