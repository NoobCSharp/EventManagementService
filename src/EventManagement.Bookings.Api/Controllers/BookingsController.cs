...
namespace EventManagement.Bookings.Api.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        /// <param name="seatCount">Количество мест для бронирования</param>
        ...
        public async Task<ActionResult<BookingDtoResponse>> CreateBooking(Guid id, int seatCount, CancellationToken cancellationToken = default)
        {
            var userId = ClaimsPrincipalExtensions.GetUserId(User);

            var bookingDtoResponse = await _bookingService.CreateBookingAsync(id, userId, seatCount, cancellationToken);
