...
namespace EventManagementService.Services
{
    public class BookingService : IBookingService
    {
        ...
        /// Примечание: текущая реализация методов не использует блокировку — необходимо
        /// применять <c>lock(_bookingLock)</c> вокруг критических разделов, если
        /// множество потоков может одновременно изменять <c>_bookingStore.Bookings</c>.
        /// </summary>
